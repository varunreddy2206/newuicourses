...
export default function Recomemded() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-10">
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Recomemded Courses</h2>
        ...
        >
          {courses.map((course, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4">
                <button className="cursor-pointer bg-blue-600 text-white px-5 py-2 rounded-full text-sm hover:bg-blue-700 flex items-center justify-center gap-2 leading-none">
                  <span className="inline-block">Enroll Now</span>
                  <span className="inline-block translate-y-px">→</span>
                </button>

                <button className="cursor-pointer border px-5 py-2 rounded-full text-sm flex items-center gap-1 justify-center leading-none">
