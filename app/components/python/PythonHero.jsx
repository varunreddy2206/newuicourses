      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight font-bold text-gray-900">
            The Complete <br />
            <span className="text-yellow-500">Python for Development</span> <br />
            & Automation
          </h1>

          {/* Subtitle */}
          <p className="text-base sm:text-lg text-gray-700 max-w-xl">
            Become a job-ready Python developer. Learn automation, scripting,
            backend, APIs, and real-time industry projects.
          </p>
